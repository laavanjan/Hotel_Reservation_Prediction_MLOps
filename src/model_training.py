...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            raise CustomException(f'Error in loading and splitting data: {e}', sys.exc_info())
    ...
    def train_lgbm(self,X_train, y_train):
        try:
            ...
            raise CustomException(f'Error in training LightGBM model: {e}', sys.exc_info())
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            ...
            raise CustomException(f'Error in evaluating model: {e}', sys.exc_info())
    ...
    def save_model(self, model):
        try:
            ...
            raise CustomException(f'Error in saving model: {e}', sys.exc_info())
